...
from capstone_inventory.models import User, Drone, drone_schema, drones_schema, db
...
def create_car(current_user_token):
    ...
    shutter_speed = request.json['shutter_speed']
    ...
    drone = Drone(name,description,price,color,shutter_speed,dimensions, weight,cost_of_prd,series,user_token = user_token )
...
def update_drone(current_user_token, id):
    ...
    drone.shutter_speed = request.json['shutter_speed']
