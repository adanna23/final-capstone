...
class Drone(db.Model):
    ...
    shutter_speed = db.Column(db.String(100))
    ...
    def __init__( self, name, description, price, color,shutter_speed,dimensions, weight, cost_of_prd, series, user_token, id = ''):
        self.id = self.set_id()
        self.name = name
...
class DroneSchema(ma.Schema):
    class Meta:
        fields = ['id','name','description', 'price', 'color', 'shutter_speed', 'dimensions', 'weight', 'cost_of_prd', 'series', 'user_token']
